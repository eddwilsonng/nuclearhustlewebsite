      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          <div className="space-y-12">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">1. Acceptance of terms</h2>
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">2. Use of the platform</h2>
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">3. Accounts</h2>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">4. Employer responsibilities</h2>
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">5. Job seeker responsibilities</h2>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">6. Intellectual property</h2>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">7. Disclaimer of warranties</h2>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">8. Limitation of liability</h2>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">9. Aggregated job listings</h2>
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">10. Governing law</h2>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">11. Changes to these terms</h2>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">12. Contact</h2>
              <p className="text-stone-500 text-sm leading-relaxed">
