...
export default function SignupPage() {
  return (
    <div className="w-full max-w-lg">
      ...
      <h1 className="font-mono text-3xl md:text-4xl font-bold text-stone-900 leading-tight mb-1">Create an account.</h1>
      ...
      <div className="space-y-3">
        ...
        >
          <div>
            <h2 className="font-mono text-sm font-bold text-stone-900 group-hover:text-yellow-500 transition-colors mb-1">
          ...
          <span className="font-mono text-stone-400 group-hover:text-stone-900 transition-colors shrink-0">→</span>
        </Link>
