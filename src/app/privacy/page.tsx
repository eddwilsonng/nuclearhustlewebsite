    ...
    <div className="min-h-screen bg-[#EDE8DF]">
      ...
      <section className="py-20 md:py-28 border-b border-[#CFC8BC]">
        <div className="max-w-4xl mx-auto px-6">
          <p className="font-mono text-xs tracking-widest uppercase text-stone-400 mb-4">Legal</p>
          <h1 className="font-mono text-3xl md:text-4xl font-bold text-stone-900 leading-tight">
            Privacy Policy
          </h1>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-gray max-w-none space-y-12">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">1. Who we are</h2>
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">2. Information we collect</h2>
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">3. How we use your information</h2>
              <ul className="space-y-2 text-sm text-stone-500">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">4. Sharing your information</h2>
              ...
              <ul className="space-y-2 text-sm text-stone-500">
                <li className="flex gap-3"><span className="font-mono text-gray-200 flex-shrink-0">—</span><span><strong className="text-stone-900 font-normal">Supabase</strong> — database, authentication, and resume storage</span></li>
                <li className="flex gap-3"><span className="font-mono text-gray-200 flex-shrink-0">—</span><span><strong className="text-stone-900 font-normal">Resend</strong> — sending transactional and marketing email, and recording delivery, bounce, and complaint events</span></li>
                <li className="flex gap-3"><span className="font-mono text-gray-200 flex-shrink-0">—</span><span><strong className="text-stone-900 font-normal">Clicky</strong> — privacy-focused website analytics</span></li>
              </ul>
              <p className="text-stone-500 text-sm leading-relaxed mt-4">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">5. Data retention</h2>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">6. Cookies & analytics</h2>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">7. Your rights</h2>
            ...
            <div>
              <h2 className="font-mono text-xl sm:text-2xl font-bold text-stone-900 mb-4">8. Changes to this policy</h2>
              <p className="text-stone-500 text-sm leading-relaxed">
