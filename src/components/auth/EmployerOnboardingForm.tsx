...
export function EmployerOnboardingForm() {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div>
        <label htmlFor="companyName" className="block font-mono text-xs tracking-widest uppercase text-gray-400 mb-2">
          Company Name
        </label>
        <input
          id="companyName"
      ...
      <div>
        <label htmlFor="companyWebsite" className="block font-mono text-xs tracking-widest uppercase text-gray-400 mb-2">
          Company Website <span className="normal-case text-gray-300">(optional)</span>
        </label>
        <input
          id="companyWebsite"
          name="companyWebsite"
      ...
      <div>
        <label htmlFor="companyDescription" className="block font-mono text-xs tracking-widest uppercase text-gray-400 mb-2">
          Company Description <span className="normal-case text-gray-300">(optional)</span>
        </label>
        <textarea
